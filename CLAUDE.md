...
These principles apply to every change in ModCad. They sit alongside
the constitution (`.specify/memory/constitution.md`), which governs
*what we build*; this file governs *how we work*.
